...
info: |
  ...
  como ejemplo. I Jornada sobre Software Libre e IA Abierta (seLIA), 2026-07-06.
...
<!--
Saludo breve, sin hype. Tono honesto y técnico. Esto va de cuidar, no de vender.
-->
...
<!--
Presentación rápida, 30-40 s. eXeLearning es el ejemplo que recorrerá toda la charla.
-->
...
<!--
Reconocer lo bueno con honestidad. Si lo niego, pierdo credibilidad para la parte crítica.
-->
...
<!--
Pausa. Aquí pivota la charla del "qué facilita" al "qué hay que proteger".
-->
...
<!--
Anclar en las 4 libertades del software libre da marco a las 5 cuestiones siguientes.
-->
...
<!--
Ejemplo: un snippet "regurgitado" de un repo con licencia incompatible puede contaminar la base.
-->
...
<!--
Distinguir gradientes de apertura. "Open weights" es marketing si no hay datos ni licencia clara.
-->
...
<!--
DCO (Developer Certificate of Origin) es ligero y encaja bien. El que abre la PR responde de la procedencia.
-->
...
<!--
Local no siempre iguala a la nube en calidad, pero da control. Es un equilibrio consciente.
-->
...
<!--
El lock-in no llega de golpe: se cuela como dependencia "temporal" que se vuelve crítica.
-->
...
<!--
Aquí aterrizo todo lo anterior en un caso concreto y honesto.
-->
...
<!--
Hablo en términos de prácticas, sin inventar datos internos. La IA propone; el humano dispone.
-->
...
<!--
El mensaje: la IA es una herramienta más dentro de un proceso que protege las 4 libertades.
-->
...
<!--
Esta es la diapositiva "para llevar a casa". Si solo recuerdan una, que sea esta.
-->
...
<!--
Leer despacio. Son cinco frases-ancla; que se queden con ellas.
-->
...
<!--
Dejar esta diapositiva fija durante el turno de preguntas.
-->
